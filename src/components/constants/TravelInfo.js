...
const TravelInfo = [ // 컴포넌트랑 같은 뎁스에 constants폴더로 넣기 , 이 폴더는 로컬 상에 필요한 데이터를 넣을 거임
  {
    name: '성욱',
    image: [recomend1, recomend2, recomend3, recomend4],
    tag: '#우정여행 #먹부림',
    date : '2023.07.19 ~ 2023.07.23 to Mongol'
  },
  {
    name: '근재',
    image: [recomend1, recomend2, recomend3, recomend4],
    tag: '#우정여행 #먹부림',
    date : '2023.07.12 ~ 2023.07.15 to Japan'
  },
  {
    name: '준민',
    image: [recomend1, recomend2, recomend3, recomend4],
    tag: '#우정여행 #먹부림',
    date : '2023.07.01 ~ 2023.07.05 to USA'
  },
];
