    ...
    <View style={styles.all}>
      ...
      <View style={styles.bottom}>
        <View style={styles.ControlView}>
            <TouchableOpacity onPress={handleBeforeKeyword} style={styles.beforeButton}>
            ...
            <TouchableOpacity onPress={handleLikeToggle} style={styles.likeButton}>
                <Image
                    source={
                    likedKeywords.includes(keyword)
                        ? require('D:/RN/OOTT-Android/src/assets/images/goodheartfilled-240.png')
                        : require('D:/RN/OOTT-Android/src/assets/images/goodheart.png')
                    }
                    style={styles.heartIcon}
                />
            </TouchableOpacity>

            <TouchableOpacity onPress={handleNextKeyword} style={styles.nextButton}>
                <Text style={styles.nextBtn}>다음</Text>
            </TouchableOpacity>
        </View>
        <View style={styles.doneBtnView}>
            <TouchableOpacity onPress={() => Alert.alert("패션 키워드 설정을 완료하시겠습니까?", "", [
