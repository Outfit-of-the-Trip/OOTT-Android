  ...
  return (
    <SafeAreaView style={style.container}>
      <View
        style={{
          flex: 0.2,
          marginHorizontal: width - (width - 15),
          marginVertical: height - (height - 10),
        }}>
        <Text style={style.toptext}>Customized OOTT</Text>
        <Text style={style.toptext}>that reflects your preference</Text>
      </View>
      <View style={{flex: 0.2, marginHorizontal: width - (width - 15)}}>
      ...
      <ScrollView style={{flex: 2.5}}>
        <View style={{flex: 0.1, marginHorizontal: width - (width - 20)}}>
          <Text style={style.cardtextcontainer}>AI Recommendation</Text>
        </View>
        <View
          style={[
            style.cardcontainer,
        ...
        <View style={{flex: 0.1, marginHorizontal: width - (width - 20)}}>
          <Text style={style.cardtextcontainer}>옷장속에 있는 유사한 하의</Text>
        </View>
        <View
          style={[
            style.cardcontainer,
      ...
      <View
        ...
        <TouchableOpacity onPress={gotoShose}>
          <Text style={style.bottomtext}>신발 -{'>'} </Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
